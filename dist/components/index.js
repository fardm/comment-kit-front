  ...
  const Component = ({ displayClass, fileData }) => {
    if (type === "recent") {
      return /* @__PURE__ */ u2("div", { class: classNames(displayClass, "recent-comments-widget"), children: [
        /* @__PURE__ */ u2("h3", { children: title || "Recent Comments" }),
        /* @__PURE__ */ u2(
          "div",
          {
            id: "ck-recent-root",
            ...
            children: /* @__PURE__ */ u2("p", { children: "Loading..." })
          }
        )
      ] });
    }
    ...
    return /* @__PURE__ */ u2("div", { class: classNames(displayClass, "standalone-comments-section"), children: /* @__PURE__ */ u2(
      "div",
      {
        id: "ck-comments-root",
        ...
        children: [
          /* @__PURE__ */ u2("h2", { class: "ck-title", children: "Comments" }),
          /* @__PURE__ */ u2("div", { class: "ck-post-reactions", "aria-label": "Post reactions" }),
          /* @__PURE__ */ u2("div", { class: "ck-list", children: /* @__PURE__ */ u2("p", { children: "Loading comments..." }) }),
          /* @__PURE__ */ u2("form", { class: "ck-form", autocomplete: "off" })
        ]
      }
    ) });
  };
